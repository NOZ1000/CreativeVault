        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          <div class="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div class="max-w-3xl mx-auto text-center pb-12">
              <h1 class="h2 font-cabinet-grotesk">Welcome back, CreativeVault!</h1>
            </div>
              ...
              >
                <div class="flex flex-wrap mb-4">
                  <div class="w-full">
                    ...
                    <input v-model="email" id="email" type="email" class="form-input w-full text-gray-800" required />
                  </div>
                </div>
                <div class="flex flex-wrap mb-4">
                  <div class="w-full">
                    <label class="block text-gray-500 text-sm font-medium mb-1" for="password">Password</label>
                    <input v-model="password" id="password" type="password" class="form-input w-full text-gray-800" required />
                  </div>
                </div>
                <div class="flex flex-wrap items-center justify-between mt-6">
                  ...
                  <div class="ml-2">
                    <button class="btn-sm text-white bg-blue-500 hover:bg-blue-600 shadow-sm">Sign In To CreativeVault</button>
                  </div>
                </div>
              </form>
            </div>
...
const signIn = async () => {
  try {
    const response = await axios.post(`http://${import.meta.env.VITE_BASE_URL}/signin`, {
      email: email.value,
