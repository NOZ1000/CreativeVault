        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          <div class="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div class="max-w-3xl mx-auto text-center pb-12">
              ...
              <h1 class="h2 font-cabinet-grotesk">Join CreativeVault</h1>
            </div>
            ...
            <div class="max-w-sm mx-auto">
              ...
              >
                ...
                <div class="flex flex-wrap items-center justify-between mt-6">
                  ...
                  <div class="ml-2">
                    <button class="btn-sm text-white bg-blue-500 hover:bg-blue-600 shadow-sm">Join CreativeVault</button>
                  </div>
                </div>
              </form>
            </div>
...
const signUp = async () => {
  try {
    const response = await axios.post(`http://${import.meta.env.VITE_BASE_URL}/signup`, {
      email: email.value,
