      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
          ...
          <div class="md:w-[640px]">
            <!-- Copy -->
            <h1 class="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">The platform for creative <span class="relative inline-flex text-blue-500">
            ...
            <p class="text-xl text-gray-500 mb-10" data-aos="fade-right" data-aos-delay="200">Safely store your creativity.</p>
            <!-- Buttons -->
